    ...
    >
      <div className="rounded-xl border bg-card p-6">
        ...
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p className="text-sm">
            Cadastre suas matérias em <a href="/planner/subjects" className="text-primary hover:underline">Planejamento → Minhas Matérias</a> para acompanhar seu desempenho.
          </p>
        </div>
      </div>
    </PageLayout>
