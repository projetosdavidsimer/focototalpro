-- =====================================================
-- FocoTotal SaaS - Database Schema
-- =====================================================
...
-- =====================================================
-- 6. DADOS DE EXEMPLO (OPCIONAL - APENAS PARA DEV)
-- =====================================================

-- Descomentar apenas em ambiente de desenvolvimento
-- INSERT INTO profiles (id, email, full_name) VALUES
--   ('00000000-0000-0000-0000-000000000001', 'teste@focototal.com', 'Usuário Teste');
...
DO $$
BEGIN
  RAISE NOTICE 'Schema FocoTotal criado com sucesso!';
